    ...
    switch (formData.service) {
      case 'Web Development':
        return (
          <>
            ...
            <option value="Basic Website">Basic Website - $500-$1,500</option>
            <option value="Business Website">Business Website - $1,500-$3,000</option>
            <option value="E-commerce Website">E-commerce Website - $3,000-$8,000</option>
            <option value="Custom Web Application">Custom Web Application - $8,000+</option>
          </>
        );
      case 'Mobile App Design':
        return (
          <>
            <option value="">Select a package</option>
            <option value="Basic App">Basic App - $2,000-$5,000</option>
            <option value="Standard App">Standard App - $5,000-$10,000</option>
            <option value="Advanced App">Advanced App - $10,000-$20,000</option>
            <option value="Enterprise App">Enterprise App - $20,000+</option>
          </>
        );
      case 'UI/UX Design':
        return (
          <>
            <option value="">Select a package</option>
            <option value="Landing Page Design">Landing Page Design - $300-$800</option>
            <option value="Website Design">Website Design (5-10 pages) - $800-$2,000</option>
            <option value="Mobile App Design">Mobile App Design - $1,500-$4,000</option>
            <option value="Complete Brand Identity">Complete Brand Identity - $2,000-$5,000</option>
          </>
        );
      case 'Digital Marketing':
        return (
          <>
            <option value="">Select a package</option>
            <option value="Starter Package">Starter Package - $500/month</option>
            <option value="Growth Package">Growth Package - $1,500/month</option>
            <option value="Professional Package">Professional Package - $3,000/month</option>
            <option value="Enterprise Package">Enterprise Package - $5,000+/month</option>
          </>
        );
      default:
        return (
    ...
    return (
      <div className="quote-page">
        <div className="quote-success">
          ...
          <p>Thank you for your order. Our team will contact you within 24 hours to confirm details and begin your project.</p>
    ...
    <div className="quote-page">
      <div className="quote-container">
        <div className="quote-header">
          <h1 className="quote-title">Place Your Order</h1>
          <p className="quote-subtitle">Select a package and provide your project details to get started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="quote-form">
          ...
          {/* Order Details */}
          <div className="quote-section">
            <h2 className="quote-section-title">Order Details</h2>
            ...
            <div className="quote-form-group">
              <label className="quote-label">Package *</label>
              <select
                name="package"
            ...
            <div className="quote-form-group">
              <label className="quote-label">Preferred Timeline *</label>
              <select
                name="timeline"
            ...
            <div className="quote-form-group">
              <label className="quote-label">Additional Details *</label>
              <textarea
                name="description"
