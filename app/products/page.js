            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                  ...
                  <h3 className="text-sm md:text-xl font-semibold text-white mb-4" style={{ lineHeight: '1.4', overflow: 'visible' }}>
                    {product.tagline}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 md:px-6 md:py-3 bg-white text-black text-xs md:text-base font-semibold rounded-full hover:scale-105 transition-all duration-300"
                    >
                    ...
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 px-5 py-2.5 md:px-6 md:py-3 border border-white/20 text-white text-xs md:text-base font-semibold rounded-full hover:bg-white/10 transition-all duration-300"
                    >
                      Request Demo
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                    <h4 className="text-base md:text-xl font-bold text-white mb-6">Key Features</h4>
                      ...
                      {product.features.map((feature, i) => (
                        <div key={i} className="flex items-start gap-3">
                          <CheckIcon
                            ...
                            style={{ color: product.color }}
                          />
                          <span className="text-gray-300 text-xs md:text-base" style={{ lineHeight: '1.6', overflow: 'visible' }}>
                            {feature}
                          </span>
                        </div>
                      ))}
