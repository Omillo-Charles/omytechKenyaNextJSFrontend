    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#0A0A0A]" style={{ overflow: 'clip' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-18 text-center" style={{ overflow: 'visible' }}>
        ...
        >
          ...
          <span className="text-xs md:text-sm text-gray-400 font-medium">Over 50+ businesses trust us</span>
        </motion.div>
        ...
        >
          <Link
            href="/contact"
            className="group relative px-8 py-4 bg-white text-black font-semibold rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
          >
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-xl md:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent mb-2">
                {stat.value}
              </div>
