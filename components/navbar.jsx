              ...
              <div className="flex flex-col h-full p-6">
                <div className="flex items-center justify-between mb-8">
                  <Link href="/" className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
                    ...
                    <span className="text-white font-bold">OMYTECH</span>
                  </Link>
                  <button
                    onClick={() => setIsOpen(false)}
                ...
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="w-full py-3 bg-white text-black font-semibold rounded-full hover:bg-gray-100 transition-all text-center"
                >
                  Get Started
                </Link>
              </div>
