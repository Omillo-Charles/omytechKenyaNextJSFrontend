...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['Technology Audit', 'Digital Strategy', 'Process Optimization', 'Team Training', 'Roadmap Planning', 'ROI Analysis'],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              { step: '04', title: 'Launch', description: 'Deploying and optimizing for growth' }
            ].map((phase, index) => (
